...
export function register(config) {
  if ('serviceWorker' in navigator) {
    ...
    if (publicUrl.origin !== window.location.origin) {
      // console.log('[App] Service Worker origin mismatch');
    ...
    window.addEventListener('load', () => {
      ...
      // console.log('[App] Service Worker URL:', swUrl);
      ...
      if (isLocalhost) {
        ...
        navigator.serviceWorker.ready.then(() => {
          // console.log(
          //   '[App] Service Worker ready. App is now PWA-enabled!'
          // );
        });
      } else {
...
function checkValidServiceWorker(swUrl, config) {
  ...
  fetch(swUrl, {
    ...
    .catch(() => {
      // console.log(
      //   '[App] No internet connection found. App is running in offline mode.'
      // );
    });
}
